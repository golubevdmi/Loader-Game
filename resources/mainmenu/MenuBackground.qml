...
Grid
{
    ...
    Repeater
    {
        ...
        Loader
        {
            property string sourceImage: getSourceImage(index, rows, columns, sokobanSymbolsList)
            ...
            Connections
            {
                ...
                onReload:
                {
                    loaderFloor.active = false;
                    loaderFloor.active = true
                }
            }
        }
    }
    function getSourceImage(index, rows, columns, sokobanSymbolsList)
    {
        var isBox = false;
